...
export default function UseModal() {
  ...
  return (
    <div>
      <TriggerButton onClick={handleOpen}>Add new transaction</TriggerButton>
      <Modal
      ...
      >
        <Fade in={open}>
          <ModalContent sx={style}>
            ...
            <TextField id="standard-basic" label="Description (optional)" variant="standard" />
            <h2></h2>
            ...
            >
                ...
                <MenuItem value={"Transportation/Fuel"}>Transportation/Fuel</MenuItem>
